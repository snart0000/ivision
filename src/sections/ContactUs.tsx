        ...
        <div className="contact-us__wrapper">
          <div className="form-container">
            <form className="form" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <input className="form-input" required type="text" name="name" value={formData.name} onChange={handleChange} />
                <label>Name</label>
                {errors.name && <small>{errors.name}</small>}
              </div>

              <div className="form-group">
                <input className="form-input" required type="email" name="email" value={formData.email} onChange={handleChange} />
                <label>Email</label>
                {errors.email && <small>{errors.email}</small>}
              </div>

              <div className="form-group">
                <input className="form-input" required type="tel" name="contactNumber" value={formData.contactNumber} onChange={handleChange} maxLength={16} />
                <label>Contact Number</label>
                {errors.contactNumber && <small>{errors.contactNumber}</small>}
              </div>

              <div className="form-group">
                <textarea className="form-input message-input" required name="message" value={formData.message} onChange={handleChange} />
                <label>Message</label>
          ...
          <div className="contact-us__info">
            ...
            <div className="contact-us__details">
              <p><FaMapMarkerAlt /> Bucana Malaki, Naic, Cavite</p>
              <p><FaPhoneAlt /> +63 923 359 3143</p>
              <p><FaEnvelope /> ivision.0426@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
